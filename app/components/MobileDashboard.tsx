...
export default function MobileDashboard() {
  ...
  return (
    <div className="bg-gray-950 lg:hidden" style={{ minHeight: '100vh' }}>
      ...
      <div style={{ paddingTop: '80px', paddingBottom: '40px' }}>
        <div className="px-4">
          ...
          <div className="bg-gray-800/50 rounded-xl p-5 mb-6">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center pb-2 border-b border-gray-700">
                ...
                <span className="text-green-400 font-bold">$129</span>
              </div>
              <div className="flex justify-between items-center pb-2 border-b border-gray-700">
                <span className="text-white font-medium">Michael O.</span>
                <span className="text-yellow-400 font-bold">$249</span>
              </div>
              <div className="flex justify-between items-center pb-2 border-b border-gray-700">
                <span className="text-white font-medium">Amina D.</span>
                <span className="text-blue-400 font-bold">$79</span>
              </div>
              <div className="flex justify-between items-center pb-2 border-b border-gray-700">
                <span className="text-white font-medium">David O.</span>
                <span className="text-green-400 font-bold">$399</span>
              </div>
              <div className="flex justify-between items-center pb-2 border-b border-gray-700">
                <span className="text-white font-medium">Fatima A.</span>
                <span className="text-red-400 font-bold">$59</span>
              </div>
              <div className="flex justify-between items-center pb-2 border-b border-gray-700">
                <span className="text-white font-medium">John M.</span>
                <span className="text-yellow-400 font-bold">$189</span>
              </div>
              <div className="flex justify-between items-center pb-2 border-b border-gray-700">
                <span className="text-white font-medium">Grace O.</span>
                <span className="text-green-400 font-bold">$299</span>
              </div>
              <div className="flex justify-between items-center pb-2 border-b border-gray-700">
                <span className="text-white font-medium">Paul K.</span>
                <span className="text-purple-400 font-bold">$159</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-white font-medium">Linda M.</span>
          ...
          <div className="grid grid-cols-2 gap-3 mb-8">
            <button className="bg-purple-600 text-white rounded-xl py-4 text-center font-medium">+ New Order</button>
            <button className="bg-gray-700 text-white rounded-xl py-4 text-center font-medium">Export</button>
          </div>
          
          {/* Extra bottom padding to ensure scroll */}
